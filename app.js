...
const WEEKLY_PLAN = {
    "MON": [
        ...
        { 
            ...
            reps: "8-12", 
            isDataEntry: true, 
            link: "https://www.youtube.com/embed/9vK4GVohtHE?si=EQL3iFmM-Tq7h8RF",
        ...
        { 
            ...
            tip: "Wykonaj ruch powoli i kontroluj go, szczególnie w fazie opuszczania ciężaru. W górnej fazie przytrzymaj skurcz mięśnia czworogłowego na 1-2 sekundy. Upewnij się, że kolana są ustawione zgodnie z osią obrotu maszyny." // <--- POPRAWKA: Dodano przecinek po "tip"
        }, 
        { 
            ...
            isDataEntry: true, 
            link: "https://www.youtube.com/embed/XlK4n44e6jU",
            tip: "Opuść pięty jak najniżej, aby poczuć rozciąganie łydek, a następnie wypchnij się mocno do góry, spinając łydki. Przytrzymaj napięcie na sekundę." // <--- POPRAWKA: Dodano przecinek po "tip"
        }, 
        { 
            ...
            isDataEntry: true, 
            link: "https://www.youtube.com/embed/XlK4n44e6jU",
            tip: "Uważaj na tempo i kontrolę.Kluczowy jest pełny zakres i kontrola fazy negatywnej (opuszczania). Możesz stanąć na podwyższeniu, aby zwiększyć rozciągnięcie." // <--- POPRAWKA: Dodano przecinek po "tip"
        }, 
        { 
            name: "Deska", 
            sets: 3, 
            reps: "Limit", 
            isDataEntry: true // <--- POPRAWKA: Dodano zamknięcie obiektu (brakuje link i tip, ale to było opcjonalne)
        } 
    ],
    ...
    "WED": [
        ...
        { 
            ...
            tip: "Ustawienie ławki – upewnij się, że sztanga ląduje na środku klatki (nie za wysoko na szyi, ani za nisko na brzuchu).Prowadź łokcie pod kątem około 45-60 stopni do tułowia, aby chronić stawy barkowe. Kontroluj ruch w dół i wyciskaj ciężar dynamicznie, ale stabilnie." // <--- POPRAWKA: Dodano przecinek po "tip"
        }, 
        { 
    ...
    "FRI": [
        ...
        { 
            ...
            sets: 3, 
            reps: "Limit", 
            isDataEntry: true // <--- POPRAWKA: Dodano zamknięcie obiektu
        }
    ],
