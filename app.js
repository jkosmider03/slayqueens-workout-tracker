...
const WEEKLY_PLAN = {
    ...
    "WED": [
        ...
        { 
            ...
            tip: "Ustawienie ławki – upewnij się, że sztanga ląduje na środku klatki (nie za wysoko na szyi, ani za nisko na brzuchu).Prowadź łokcie pod kątem około 45-60 stopni do tułowia, aby chronić stawy barkowe. Kontroluj ruch w dół i wyciskaj ciężar dynamicznie, ale stabilnie." 
        }, 
        { 
