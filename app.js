...
const WEEKLY_PLAN = {
    "MON": [
        ...
        { name: "Hip Thrusty", sets: 4, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/watch?v=cNJdUkA3ycw" },
        { name: "Hamstring Curls (maszyna)", sets: 3, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/watch?v=Wy1SwoY2aaQ" },
        { name: "Przysiady ze skokiem", sets: 3, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/watch?v=33HszL92jqQ" },
        { name: "Suwnica", sets: 3, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/watch?v=-w1u2DtnPHo" },
        { name: "Schodki", sets: 1, reps: "15 min", isDataEntry: false },
    ],
    "TUES": [{ name: "Odpoczynek", sets: 0, reps: "Full Day Off", isDataEntry: false }],
    "WED": [
        { name: "Rozgrzewka", sets: 1, reps: "5-10 min", isDataEntry: false },
        { name: "Drążek do cycków (maszyna)", sets: 3, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/watch?v=kqZJmKosr3M" },
        { name: "Wyciskanie barki", sets: 3, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/watch?v=TnhIyp4kmO8" },
        { name: "Bent-Over Row (podparcie na pieska)", sets: 3, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/watch?v=0lQ4oVlIfwA" },
        { name: "Prostowanie przedramion (maszyna)", sets: 3, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/watch?v=P6h0qD8cQt4" },
        { name: "Rozpiętki", sets: 1, reps: "5 min", isDataEntry: false, link: "https://www.youtube.com/embed/watch?v=_NuiU857O6Q" },
    ...
    "FRI": [
        ...
        { name: "RDL", sets: 3, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/WIcpu2UkJoY?si=84MrSzxpZMnltnwU" },
        { name: "Chest Press (maszyna)", sets: 3, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/watch?v=YVbiDGkZyx0" },
        { name: "Wiosłowanie na wyciągu", sets: 3, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/watch?v=wCz9JH3kkz8" },
        { name: "Zakroki w tył", sets: 3, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/watch?v=riKLjcE88jQ" },
        { name: "Wznosy ramion w bok", sets: 3, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/watch?v=dwtuq69BAeY" },
        { name: "Wypychanie nóg na maszynie", sets: 3, reps: "8-12", isDataEntry: true, link: "https://www.youtube.com/embed/watch?v=qYxo9ZFvHQE" },
        { name: "Schodki", sets: 1, reps: "15 min", isDataEntry: false },
    ],
...
html += `<tr data-exercise-id="${index}">
        ...
        if (exercise.link) {
            // Jeśli jest link, nazwa jest klikalna i wywołuje funkcję showInstruction
...
function showInstruction(title, link) {
    ...
    // Tworzenie elementu iframe (dla wideo z YouTube)
    ...
    // Możesz zamienić powyższy iframe na tag <img>, jeśli podasz link do obrazka:
    // const imageHtml = `<img src="${link}" alt="Instrukcja ćwiczenia ${title}">`;
...
// Zdarzenie: Delegacja kliknięcia na nazwach ćwiczeń (po wyrenderowaniu planu)
document.addEventListener('click', (e) => {
    if (e.target.classList.contains('clickable-ex-name')) {
...
// Dodatkowa stylizacja dla klikalnej nazwy
document.addEventListener('DOMContentLoaded', () => {
    // ... (pozostały kod CSS z app.js)
    const style = document.createElement('style');
    style.innerHTML += `
        .clickable-ex-name {
            cursor: pointer;
